package example.com.mytextanimation.fragment;
...
import example.com.mytextanimation.activity.ListViewBarEditActivity;
import example.com.mytextanimation.adapter.HorizontalRecyclerviewAdapter;
import example.com.mytextanimation.adapter.NoHorizontalScrollerVPAdapter;
import example.com.mytextanimation.emotionkeyboardview.EmotionKeyboard;
import example.com.mytextanimation.emotionkeyboardview.NoHorizontalScrollerViewPager;
import example.com.mytextanimation.model.ImageModel;
import example.com.mytextanimation.utils.EmotionUtils;
import example.com.mytextanimation.utils.GlobalOnItemClickManagerUtils;
import example.com.mytextanimation.utils.SharedPreferencedUtils;
...
public class EmotionMainFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mEmotionKeyboard = EmotionKeyboard.with(getActivity())
                ...
                .bindToContent(contentView)//绑定内容view,用于固定高度
        ...
        bar_btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(content)){
                   Toast.makeText(getContext(),getActivity().getClass().getSimpleName(),Toast.LENGTH_LONG).show();
                    Log.i(getActivity().getClass().getSimpleName(),"点击后拿到的content值为："+content);
                    ((ListViewBarEditActivity)getActivity()).addMdata(content);
                }
            }
        });
