package example.com.mytextanimation.emotionkeyboardview;
...
import example.com.mytextanimation.utils.LogUtils;
...
public class EmotionKeyboard {
	    ...
	    /**
	     * 绑定内容view，此view用于固定bar的高度，防止跳闪，这里具体指ListView
	     * @param contentView
	     * @return
	     */
	        ...
	        emotionButton.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if (mEmotionLayout.isShown()) {
						...
						//如果软键盘处于显示状态，则锁定高度，为表情显示时，获取对应高度
